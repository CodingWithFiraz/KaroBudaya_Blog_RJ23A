...
const Index: React.FC = () => {
  ...
  const destinationArticles = publishedArticles.filter(
    article => article.category === 'Destinasi & Tempat'
  ).slice(0, 5);
  ...
  const heritageArticles = [...publishedArticles].sort(
  ...
  const categoryGroups = [
    { title: 'Musik Karo', slug: 'musik-karo' },
    { title: 'Kuliner Karo', slug: 'kuliner-karo' },
    { title: 'Budaya & Tradisi Karo', slug: 'budaya-tradisi-karo' },
  ];
  ...
  const getArticlesByCategory = (categorySlug: string) => {
    ...
    return publishedArticles.filter(
      article => article.category === categoryMap[categorySlug]
    ).slice(0, 2);
  };
      ...
      <main className="flex-grow pt-20">
        ...
        <section className="container mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="space-y-4 mt-6">
              {destinationArticles.length > 0 ? (
                destinationArticles.map(article => (
                  <Link 
                    key={article.id}
                    to={`/article/${article.id}/${article.title.toLowerCase().replace(/[^\w\s-]/g, '').replace(/\s+/g, '-')}`}
                    className="flex items-start gap-3 hover:bg-karo-darkbeige/20 p-2 rounded-md transition-colors"
                  >
                    <img 
                ...
                <div className="text-center text-sm text-karo-brown py-4">
          ...
          <div className="lg:col-span-9">
            {featuredArticle ? (
              ...
              <div className="h-[500px] bg-karo-darkbeige/20 rounded-xl flex items-center justify-center">
        ...
        <section className="container mx-auto px-4 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {latestArticles.length > 0 ? (
              ...
              <div className="col-span-3 text-center py-12 bg-karo-cream rounded-xl">
        ...
        <section className="bg-karo-cream py-12">
          <div className="container mx-auto px-4">
            <div className="flex items-baseline justify-between mb-8">
              <h2 className="text-2xl font-serif font-bold">Warisan Budaya</h2>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <div className="relative h-[400px] overflow-hidden rounded-xl">
                    <img 
                      src="/lovable-uploads/5e2f1dda-2d6c-44e5-9a3a-87b1ba1c8088.png" 
                      alt="Uis Karo"
        ...
        <section className="container mx-auto px-4 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {categoryGroups.map(category => (
              <Card key={category.slug} className="overflow-hidden border-none shadow-md">
                ...
                <CardContent className="p-0">
                  {getArticlesByCategory(category.slug).length > 0 ? (
                    ...
                    <div className="text-center py-8 text-karo-brown text-sm">
                  ...
                  <div className="p-4 border-t">
                    <Link 
                      ...
                      className="text-karo-gold flex items-center hover:underline text-sm justify-end"
                    >
                      Lihat Semua
                      <ArrowRight size={16} className="ml-1" />
                    </Link>
